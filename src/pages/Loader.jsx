...
import loaderathlete from '../assets/animations/loaderathlete.json'
import mobileloader from '../assets/animations/mobileloader.json'
...
const Loader = () => {
    ...
    const animationToPlay = width > 600 ? loaderathlete : mobileloader
        ...
        <div className='flex min-h-screen text-white' style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' }}>
            <main className='flex-1 flex bg-aber-300 justify-center mt-22 items-start'>
                <div className="x8 py-2 relative mx-auto flex flex-col pr-24 w-12/12 pl-[25%]">
                    ...
                    <Lottie className='absolute left-[00px] pl-[20%]' lottieRef={lottieRef} autoPlay={false} animationData={animationToPlay} loop={false} style={{ backgrondColor: 'rgba(100,400,100,0.2)', width: '100%' }} />
